                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="assets/images/profile/avatar.png" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ route('home.profile') }}" class="dropdown-item ai-icon">
                            ...
                            <form action="{{ route('logout.action') }}" method="POST" class="dropdown-item ai-icon">
                                @csrf
                                <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger"
                                    width="18" height="18" viewbox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <button type="submit" class="btn btn-link p-0 m-0 align-baseline"><span class="ms-2">Logout </span></button>
                            </form>
                        </div>
                    </li>
                </ul>
